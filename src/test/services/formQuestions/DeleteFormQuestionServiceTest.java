...
class DeleteFormQuestionServiceTest {
    ...
    @Spy
    @InjectMocks
    DeleteFormQuestionService service = new DeleteFormQuestionService();
    ...
    public void setup() throws SQLException, IOException {
        ...
        when(formsQuestionsRepository.delete(anyInt())).thenReturn(true);
    ...
    public void execute() throws Exception {
        ...
        //verify
        verify(formsQuestionsRepository).delete(any());
    }
